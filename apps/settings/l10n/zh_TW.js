OC.L10N.register(
    ...
    "installing and updating apps via the App Store or Federated Cloud Sharing" : "透過應用程式商店，或聯邦雲端分享，來安裝、更新應用程式",
    "Federated Cloud Sharing" : "聯邦雲端分享",
    "cURL is using an outdated %1$s version (%2$s). Please update your operating system or features such as %3$s will not work reliably." : "cURL 使用的 %1$s 版本過舊 (%2$s)。請更新您的作業系統，否則如 %3$s 等功能可能無法正常運作。",
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://nextcloud.com. Please check the Nextcloud log file for more details." : "對於 https://nextcloud.com 的 HTTPS 請求發生錯誤，因此無法判定 cURL 的 TLS 版本是否過舊。請查閱 Nextcloud 的紀錄檔以了解更多細節。",
    ...
    "OPcache is disabled. For better performance, it is recommended to apply <code>opcache.enable=1</code> to your PHP configuration." : "已停用 OPcache。如果要取得更好的效能，建議在您的 PHP 組態設定中套用 <code>opcache.enable=1</code>。",
    ...
    "Nextcloud is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all Nextcloud directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during Nextcloud core or app upgrades." : "Nextcloud 不允許使用 OPcache API。若啟用 OPcache，強烈建議以 <code>opcache.restrict_api</code> 涵蓋所有 Nextcloud 目錄，或是取消停用 OPcache API 限制的這個設定，以避免在 Nextcloud 核心或應用程式升級期間發生錯誤。",
    "Nextcloud is not allowed to use the OPcache API. It is highly recommended to include all Nextcloud directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during Nextcloud core or app upgrades." : "Nextcloud 不允許使用 OPcache API。強烈建議使用 <code>opcache.restrict_api</code> 涵蓋所有 Nextcloud 目錄，或是取消停用 OPcache API 限制的這個設定，以避免在 Nextcloud 核心或應用程式升級期間發生錯誤。",
    "The shared memory based OPcache is disabled. For better performance, it is recommended to apply <code>opcache.file_cache_only=0</code> to your PHP configuration and use the file cache as second level cache only." : "以共享記憶體為基礎的 OPcache 已停用。如果要有更好的效能，建議套用 <code>opcache.file_cache_only=0</code> 到您的 PHP 組態設定中，並僅將檔案快取作為第二級快取。",
    "The maximum number of OPcache keys is nearly exceeded. To assure that all scripts can be kept in the cache, it is recommended to apply <code>opcache.max_accelerated_files</code> to your PHP configuration with a value higher than <code>%s</code>." : "幾乎超過了 OPcache 鍵的最大數量。為確保幾乎所有命令稿都可以保留在快取中，建議在您 PHP 組態設定中的 <code>opcache.max_accelerated_files</code> 套用高於 <code>%s</code> 的值。",
    "The OPcache buffer is nearly full. To assure that all scripts can be hold in cache, it is recommended to apply <code>opcache.memory_consumption</code> to your PHP configuration with a value higher than <code>%s</code>." : "OPcache 緩衝區幾乎快滿了。為確保所有命令稿都可以保留在快取中，建議在您 PHP 組態設定中的 <code>opcache.memory_consumption</code> 套用高於 <code>%s</code> 的值。",
    "The OPcache interned strings buffer is nearly full. To assure that repeating strings can be effectively cached, it is recommended to apply <code>opcache.interned_strings_buffer</code> to your PHP configuration with a value higher than <code>%s</code>." : "OPcache 內部字串緩衝區幾乎快滿了。為確保可以有效快取重複字串，建議在您 PHP 組態設定中的 <code>opcache.interned_strings_buffer</code> 套用高於 <code>%s</code> 的值。",
    ...
    "Allow username autocompletion to users based on phone number integration" : "允許出自電話號碼整合的使用者自動完成使用者名稱",
    ...
    "Two-factor authentication can be enforced for all users and specific groups. If they do not have a two-factor provider configured, they will be unable to log into the system." : "可對所有使用者與特定群組強制啟用雙因素認證。如果他們沒有設定雙因素認證提供者，那麼他們就會無法登入系統。",
    "Enforce two-factor authentication" : "強制雙因素認證",
    "Limit to groups" : "限制給特定群組",
    "Enforcement of two-factor authentication can be set for certain groups only." : "強制雙因素認證可僅為某些群組設定。",
    "Two-factor authentication is enforced for all members of the following groups." : "對以下群組的所有成員強制開啟雙因素認證。",
    "Enforced groups" : "強制的群組",
    "Two-factor authentication is not enforced for members of the following groups." : "以下群組的成員不強制開啟雙因素認證。",
    "Excluded groups" : "排除的群組",
    "When groups are selected/excluded, they use the following logic to determine if a user has 2FA enforced: If no groups are selected, 2FA is enabled for everyone except members of the excluded groups. If groups are selected, 2FA is enabled for all members of these. If a user is both in a selected and excluded group, the selected takes precedence and 2FA is enforced." : "選取/排除群組時，其使用以下邏輯來確定使用者是否強制啟用雙因素認證：如果沒有選取群組，雙因素認證對所有除了排除群組以外的成員啟用。若選取了群組，則雙因素認證會對所有該群組的成員啟用。如果某個使用者同時位在選取與排除的群組，則被選取的群組優先程度較高，因此會強制啟用雙因素認證。",
    "Save changes" : "儲存變更",
    "All" : "所有",
    ...
    "_%n app has an update available_::_%n apps have an update available_" : ["%n 個應用程式有可用的更新","%n 個應用程式有可用的更新"],
    "_Update_::_Update all_" : ["更新全部","更新全部"],
    "Device name" : "裝置名稱",
    ...
    "Error while deleting the token" : "刪除代符時發生錯誤",
    ...
    "_{userCount} user_::_{userCount} users_" : ["{userCount} 個使用者","{userCount} 個使用者"],
    "Avatar" : "頭像",
    ...
    "If you use third party applications to connect to Nextcloud, please make sure to create and configure an app password for each before enabling second factor authentication." : "如果您使用第三方應用程式連線到 Nextcloud，請確保在啟用雙因素認證前，已為每個應用程式設定應用程式密碼。"
},
"nplurals=1; plural=0;");
