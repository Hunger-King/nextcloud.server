OC.L10N.register(
    ...
    "The OPcache buffer is nearly full. To assure that all scripts can be hold in cache, it is recommended to apply <code>opcache.memory_consumption</code> to your PHP configuration with a value higher than <code>%s</code>." : "OPcache 緩衝區幾乎快滿了。為確保所有 script 都可以保留在快取中，建議在您 PHP 組態設定中的 <code>opcache.memory_consumption</code> 套用高於 <code>%s</code> 的值。",
