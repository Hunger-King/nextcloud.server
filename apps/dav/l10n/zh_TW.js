OC.L10N.register(
    ...
    "Automatically set user status to \"Do not disturb\" outside of availability to mute all notifications." : "在可見時間以外，自動將使用者狀態設定為「請勿打擾」以靜音所有通知。",
    "Failed to load availability" : "可見時間載入失敗",
    "Saved availability" : "已儲存可見時間",
    "Failed to save availability" : "儲存可見時間失敗",
    "Availability" : "可見時間",
