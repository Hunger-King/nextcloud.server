OC.L10N.register(
    ...
    {
    "You created two-factor backup codes for your account" : "您已建立您帳號的雙因素認證的備用碼",
    "Second-factor backup codes" : "雙因素認證備用碼",
    "Generate backup codes" : "產生備用碼",
    "You enabled two-factor authentication but did not generate backup codes yet. They are needed to restore access to your account in case you lose your second factor." : "您已啟用雙因素認證，但尚未產生備用碼。如果您失去第二因素的認證方式，則必須使用備用碼來恢復對您帳號的存取權。",
    "Backup code" : "備用碼",
    "Use backup code" : "使用備用碼",
    "Two factor backup codes" : "雙因素認證備用碼",
    "A two-factor auth backup codes provider" : "雙因素認證備用碼提供者",
    ...
    "Use one of the backup codes you saved when setting up two-factor authentication." : "設定啟用雙因素認證時，可輸入其中一組您已儲存的備用碼。",
    "Submit" : "提交"
},
"nplurals=1; plural=0;");
