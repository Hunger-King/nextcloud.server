OC.L10N.register(
    ...
    "_%n group found_::_%n groups found_" : ["找到 %n 個群組","找到 %n 個群組"],
    "> 1000 groups found" : "找到 > 1000 個群組",
    "> 1000 users found" : "找到 > 1000 個使用者",
    "_%n user found_::_%n users found_" : ["找到 %n 個使用者","找到 %n 個使用者"],
    ...
    "By default, the UUID attribute is automatically detected. The UUID attribute is used to doubtlessly identify LDAP users and groups. Also, the internal username will be created based on the UUID, if not specified otherwise above. You can override the setting and pass an attribute of your choice. You must make sure that the attribute of your choice can be fetched for both users and groups and it is unique. Leave it empty for default behavior. Changes will have effect only on newly mapped (added) LDAP users and groups." : "預設情況下，UUID 特性會自動偵測。UUID 特性用來準確識別 LDAP 使用者及群組。此外，如果未在上方指定，則內部使用者名稱會以 UUID 為基礎建立。您可以凌駕設定，並且根據您的想法直接傳定特性，但一定要確保指定的特性能被使用者及群組取得且唯一。留空將採取預設行為。變更只會對新映射（新增）的 LDAP 使用者及群組生效。",
