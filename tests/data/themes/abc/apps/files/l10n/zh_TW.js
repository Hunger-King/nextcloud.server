OC.L10N.register(
    ...
    "Size" : "大小",
    "Modified" : "修改時間",
    "_%n folder_::_%n folders_" : ["%n 個資料夾","%n 個資料夾"],
    "_%n file_::_%n files_" : ["%n 個檔案","%n 個檔案"],
    "{dirs} and {files}" : "{dirs} 和 {files}",
    "_including %n hidden_::_including %n hidden_" : ["包含 %n 個隱藏檔","包含 %n 個隱藏檔"],
    "You do not have permission to upload or create files here" : "您無權在此上傳或建立檔案",
    "_Uploading %n file_::_Uploading %n files_" : ["正在上傳 %n 個檔案","正在上傳 %n 個檔案"],
    "New" : "新增",
    ...
    "_matches \"{filter}\"_::_match \"{filter}\"_" : ["符合「{filter}」","符合「{filter}」"],
    ...
    "Path" : "路徑",
    "_%n byte_::_%n bytes_" : ["%n 位元組","%n 位元組"],
    "Favorited" : "已加入喜愛",
    "Favorite" : "喜愛",
    ...
    "_{count} file_::_{count} files_" : ["{count} 個檔案","{count} 個檔案"],
    "_{count} folder_::_{count} folders_" : ["{count} 個資料夾","{count} 個資料夾"],
    ...
    "If you have enabled 2FA, you must create and use a new app password by clicking here." : "若您啟用了雙因素認證，您必須點擊此處建立並使用新的應用程式密碼。",
    ...
    "_{folderCount} folder_::_{folderCount} folders_" : ["{folderCount} 個資料夾","{folderCount} 個資料夾"],
    "_{fileCount} file_::_{fileCount} files_" : ["{fileCount} 個檔案","{fileCount} 個檔案"],
    "_1 file and {folderCount} folder_::_1 file and {folderCount} folders_" : ["1 個檔案與 {folderCount} 個資料夾","1 個檔案與 {folderCount} 個資料夾"],
    "_{fileCount} file and 1 folder_::_{fileCount} files and 1 folder_" : ["{fileCount} 個檔案與 1 個資料夾","{fileCount} 個檔案與 1 個資料夾"],
